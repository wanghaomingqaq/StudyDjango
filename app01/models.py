...
class Login(models.Model):
    ...
    coin_num = models.CharField(max_length=256,default="0")
    dio_num = models.CharField(max_length=256,default="0")
    exp_num = models.CharField(max_length=256,default="0")
...
class Study(models.Model):
    ...
    coin_num = models.CharField(max_length=256)
    dio_num = models.CharField(max_length=256)
    exp_num = models.CharField(max_length=256)
